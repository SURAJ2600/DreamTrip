...
public class ProgressView extends View {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            stationaryCircleColor = typedArray.getColor(R.styleable.ProgressView_stationary_circle_color, Color.parseColor(CIRCLE_COLOR));
            fadingCircleColor = typedArray.getColor(R.styleable.ProgressView_fading_circle_color, Color.parseColor(CIRCLE_COLOR));
            oribitingCircleColor = typedArray.getColor(R.styleable.ProgressView_orbiting_circle_color, Color.parseColor(CIRCLE_COLOR));
            roationDirection = typedArray.getInt(R.styleable.ProgressView_direction, 0);
            rStationary = typedArray.getDimension(R.styleable.ProgressView_stationary_circle_radius, 12f);
            float orbitingCircleRadius = typedArray.getDimension(R.styleable.ProgressView_orbiting_circle_radius, 6f);
